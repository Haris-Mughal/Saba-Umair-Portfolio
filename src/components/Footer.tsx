  ...
  return (
    <footer className="bg-secondary text-secondary-foreground py-12 relative">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        onClick={scrollToTop}
        className="absolute bottom-6 right-6 w-12 h-12 bg-primary hover:bg-primary/90 text-primary-foreground rounded-full flex items-center justify-center shadow-card hover:shadow-floating transition-all duration-300"
      >
