...
const Hero = () => {
  ...
  return <section id="hero" className="min-h-screen flex items-center relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            duration: 0.8
              ...
              duration: 0.6
                ...
                Transforming ideas into compelling content that drives engagement, 
                boosts SEO rankings, and converts readers into customers.
              </motion.p>
              ...
              duration: 0.6
                ...
                <Button onClick={() => scrollToSection('contact')} size="lg" className="text-primary-foreground shadow-card group bg-[5#f8fafc] bg-[#3c83f6]">
                  Hire Me
                  <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                </Button>
                
                <Button onClick={() => scrollToSection('portfolio')} variant="outline" size="lg" className="border-primary text-primary hover:bg-primary hover:text-primary-foreground">
                  View My Work
                ...
                ease: "easeInOut"
                  ...
                  <div className="text-center">
                    <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center mx-auto mb-4">
                      <span className="text-primary-foreground text-2xl font-bold">SW</span>
                    </div>
                    <h3 className="font-heading text-xl font-semibold mb-2">Content Strategy</h3>
                    <p className="text-muted-foreground text-sm">
                      Crafting words that resonate with your audience and drive meaningful engagement.
                    </p>
                  </div>
                </motion.div>
      ...
      delay: 1.2,
      duration: 0.6
    }} className="absolute bottom-8 left-1/2 transform -translate-x-1/2 cursor-pointer" onClick={() => scrollToSection('about')}>
        <motion.div animate={{
        y: [0, 10, 0]
      }} transition={{
        duration: 1.5,
